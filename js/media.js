document.addEventListener('DOMContentLoaded', function() {
    ...
    galleryImages.forEach(image => {
        image.addEventListener('click', function() {
            ...
            const title = imageCard.querySelector('.image-title').textContent;
            const date = imageCard.querySelector('.image-date').textContent;
            const description = imageCard.querySelector('.image-description').textContent;
