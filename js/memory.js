document.addEventListener('DOMContentLoaded', function() {
    ...
    function endGame() {
        ...
        if (finalScore > highScore) {
            highScore = Math.round(finalScore);
        ...
        showCelebrationOverlay(finalScore);
    }
    ...
    function showCelebrationOverlay(finalScore) {
        celebrationOverlay.innerHTML = `
            <div class="celebration-content">
                <h2>🎉 You Did It! 🎉</h2>
                <p>You've matched all the birthday pairs for Madam Jii!</p>
    ...
    window.shareScore = function(platform) {
        ...
        if (platform === 'whatsapp') {
            window.open(`https://wa.me/7019670262?text=${encodeURIComponent(text + ' ' + url)}`, '_blank');
