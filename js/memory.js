document.addEventListener('DOMContentLoaded', function() {
    ...
    window.shareScore = function(platform) {
        const gameUrl = "https://burhan-012345.github.io/Birthday-wish/memory.html";
        const message = `🎂🎉🎁 I scored ${Math.round(currentFinalScore)} points in Madam Jii's Birthday Memory Match! 🎮✨ Can you beat my score? 🏆 Play the game here: ${gameUrl} #BirthdayFun #MemoryGame`;
        
        if (platform === 'whatsapp') {
            // WhatsApp sharing with direct message to specific number
            window.open(`https://wa.me/7019670262?text=${encodeURIComponent(message)}`, '_blank');
        } else if (platform === 'instagram') {
            // Instagram sharing solution with instructions
            const sharePanel = document.createElement('div');
            sharePanel.style.position = 'fixed';
            sharePanel.style.top = '0';
            sharePanel.style.left = '0';
            sharePanel.style.width = '100%';
            sharePanel.style.height = '100%';
            sharePanel.style.backgroundColor = 'rgba(0,0,0,0.9)';
            sharePanel.style.zIndex = '10000';
            ...
            sharePanel.innerHTML = `
                <div style="background: linear-gradient(135deg, #ff6b6b, #ff8e8e);
                    ...
                    <h2 style="margin-top: 0;">Share Your Score! ✨</h2>
                    <p>To share with <strong>obito_x_failure_</strong> on Instagram:</p>
                    ...
                    <div style="background: rgba(255,255,255,0.2);
                        ...
                        <ol style="margin: 0; padding-left: 20px;">
                            <li style="margin-bottom: 10px;">Open Instagram</li>
                            <li style="margin-bottom: 10px;">Go to <strong>obito_x_failure_</strong>'s profile</li>
                            <li style="margin-bottom: 10px;">Tap <strong>Message</strong></li>
                            <li>Paste this message:</li>
                        </ol>
                    </div>
                    
                    <textarea id="igMessage" 
                              style="width: 100%;
                                     height: 120px;
                                     padding: 12px;
                                     border-radius: 8px;
                    ...
                    <div style="display: flex; justify-content: center; gap: 10px;">
                        <button onclick="copyToClipboard('igMessage')"
                        ...
                        <button onclick="window.open('https://www.instagram.com/obito_x_failure_', '_blank')"
                                style="background: white;
                                       color: #ff6b6b;
                                       border: none;
                                       padding: 10px 20px;
